...
public:
    ...
    // Get source points for calibration
    std::vector<cv::Point2f> getSourcePoints() const { return src_points_; }
    
    //Set pixel scale from MPC
    void setPixelScale(float pixel_per_meter) { 
